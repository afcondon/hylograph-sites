...
(() => {
  ...
  var setAttribute4 = (el) => (name15) => (value12) => () => {
    if (name15 === "textContent") {
      el.textContent = value12;
    } else if (name15.startsWith("xlink:")) {
      el.setAttributeNS("http://www.w3.org/1999/xlink", name15, value12);
  ...
  var tickAttr = function(deltaMs) {
    return function(attr3) {
      return {
        attrName: attr3.attrName,
        from: attr3.from,
        to: attr3.to,
        duration: attr3.duration,
        delay: attr3.delay,
        easing: attr3.easing,
        elapsed: attr3.elapsed + deltaMs
      };
    };
  };
  var currentAttrValue = function(attr3) {
    var effectiveElapsed = max4(0)(attr3.elapsed - attr3.delay);
    var rawProgress = (function() {
      var $25 = attr3.duration <= 0;
      if ($25) {
        return 1;
      }
      ;
      return min4(1)(effectiveElapsed / attr3.duration);
    })();
    var easedProgress = attr3.easing(rawProgress);
    return lerp(attr3.from)(attr3.to)(easedProgress);
  };
  var attrComplete = function(attr3) {
    return attr3.elapsed >= attr3.duration + attr3.delay;
  };
  ...
  var applyAttr = function(el) {
    return function(attr3) {
      var value12 = currentAttrValue(attr3);
      return setAttribute4(el)(attr3.attrName)(show4(value12));
    };
  };
  var tickElement = function(deltaMs) {
    return function(et) {
      var attrs$prime = map9(tickAttr(deltaMs))(et.attrs);
      return function __do2() {
  ...
  var tickTransitions = function(deltaMs) {
    return function(v) {
      return function __do2() {
        var entering$prime = traverse2(tickElement(deltaMs))(v.entering)();
        var activeEntering = filter(function($30) {
          return !elementComplete($30);
        })(entering$prime);
        var updating$prime = traverse2(tickElement(deltaMs))(v.updating)();
        var activeUpdating = filter(function($31) {
          return !elementComplete($31);
        })(updating$prime);
        var exiting$prime = traverse2(tickElement(deltaMs))(v.exiting)();
            ...
            return function(phaseSpec) {
              return function(idx) {
                ...
                if (phaseSpec.transition instanceof Just) {
                  ...
                  var baseDelay = fromMaybe(0)(map14(unwrap2)(phaseSpec.transition.value0.delay));
                  ...
                  return map22(catMaybes)(traverse3(mkUpdateTransition(el)(duration2)(delay)(easing))(templateAttrs));
                }
                ;
          ...
          return function(phaseSpec) {
            return function(idx) {
              ...
              if (phaseSpec.transition instanceof Just) {
                ...
                var delay = baseDelay + staggerDelay * toNumber(idx);
                var easing = toTickEasing(phaseSpec.transition.value0.easing);
                return map22(catMaybes)(traverse3(mkExitTransition(el)(duration2)(delay)(easing))(phaseSpec.attrs));
              }
              ;
            ...
            return function(phaseSpec) {
              return function(idx) {
                ...
                if (phaseSpec.transition instanceof Just) {
                  ...
                  var delay = baseDelay + staggerDelay * toNumber(idx);
                  var easing = toTickEasing(phaseSpec.transition.value0.easing);
                  return map22(catMaybes)(traverse3(mkEnterTransition(duration2)(delay)(easing)(templateAttrs))(phaseSpec.attrs));
                }
                ;
                    ...
                    return function(datum) {
                      ...
                      if (itemTree instanceof Elem2) {
                        return function __do2() {
                          ...
                          return {
                            element: el,
                            childSelections: foldl2(union3)(empty2)(map13(function(v) {
                              return v.selections;
                            })(childMaps)),
                            transitions
                          };
            ...
            if (v instanceof MkFold) {
              return runSomeFold(v.value0)(function(foldSpec) {
                ...
                return function __do2() {
                  ...
                  var elements = map13(function(v1) {
                    return v1.element;
                  })(results);
                  var childMaps = foldl2(union3)(empty2)(map13(function(v1) {
                    return v1.childSelections;
                  })(results));
                  return {
                    selections: insert4(foldSpec.name)(elements)(childMaps),
                    entering: [catMaybes(map13(function(v1) {
            ...
            return function(v) {
              ...
              if (v instanceof MkFold) {
                return runSomeFold(v.value0)(function(spec) {
                  ...
                  var newKeys = fromFoldable5(map13(spec.keyFn)(items2));
                  ...
                  return function __do2() {
                    ...
                    var existingKeys = fromFoldable5(map13(function(v1) {
                      return v1.key;
                    })(existingKeysAndEls));
                    ...
                    var updateElements = map13(function(v1) {
                      return v1.element;
                    })(filter(function(v1) {
                      return member3(v1.key)(updateKeys);
                    })(existingKeysAndEls));
                    var enterElements = map13(function(v1) {
                      return v1.element;
                    })(enterResults);
                    var childMaps = foldl2(union3)(empty2)(map13(function(v1) {
                      return v1.childSelections;
  ...
  var Shuffle = /* @__PURE__ */ (function() {
    ...
    ;
    Shuffle2.value = new Shuffle2();
    return Shuffle2;
  })();
  var toLetters = function(s) {
  ...
  var strings = ["abcdef", "bdfhj", "acegik", "cfi", "abcdefghij", "dgjm", "behk"];
  var letterChart = function(letters) {
    return elem2(SVG.value)([viewBox(0)(0)(500)(300), width2(500), height2(300)])([forEachWithGUP("letters")(Text2.value)(letters)(function(v) {
      return v.letter;
    })(function(d) {
      return elem2(Text2.value)([x(40 + toNumber(d.index) * 45), y(150), fontSize("36"), textAnchor("middle"), staticStr("dominant-baseline")("middle"), fill("#2c3e50"), opacity("1"), staticStr("textContent")(d.letter)])([]);
    })({
      enter: new Just({
        attrs: [staticNum("y")(30), staticNum("opacity")(0), staticStr("fill")("#27ae60")],
      ...
      update: new Just({
        attrs: [staticNum("y")(150), staticStr("fill")("#2c3e50"), staticNum("opacity")(1)],
        transition: new Just(transitionWith({
          duration: 1200,
          delay: Nothing.value,
      ...
      exit: new Just({
        attrs: [staticNum("y")(270), staticNum("opacity")(0), staticStr("fill")("#e74c3c")],
        transition: new Just(transitionWith({
          duration: 1200,
          delay: Nothing.value,
          staggerDelay: new Just(30),
  ...
  var animLoop = function(ts) {
    return raf_(function __do2() {
      var result = tickTransitions(16)(ts)();
      if (result instanceof Running) {
        return animLoop(result.value0)();
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at App (line 113, column 3 - line 115, column 26): " + [result.constructor.name]);
    });
  };
  var renderWithTransitions = function(letters) {
    return function __do2() {
      var result = rerender("#viz")(letterChart(letters))();
      if (result.transitions instanceof Nothing) {
        return unit;
      }
      ;
      if (result.transitions instanceof Just) {
        return animLoop(result.transitions.value0)();
      }
      ;
      throw new Error("Failed pattern match at App (line 106, column 3 - line 108, column 27): " + [result.transitions.constructor.name]);
    };
  };
  var component = function(dictMonadAff) {
    ...
    return mkComponent({
      ...
      render: function(v) {
        return div_([h1_([text("General Update Pattern")]), p_([text("Click Shuffle. Letters enter from the top (green), slide to new positions, and exit through the bottom (red).")]), button([onClick(function(v1) {
          return Shuffle.value;
        })])([text("Refresh")]), div2([id2("viz")])([])]);
      },
      "eval": mkEval({
        ...
        handleAction: function(v1) {
          if (v1 instanceof Init) {
            return liftEffect7(renderWithTransitions(toLetters(fromMaybe("abcdef")(index(strings)(0)))));
          }
          ;
          if (v1 instanceof Shuffle) {
            return bind12(get2)(function(st) {
              var next = mod2(st.idx + 1 | 0)(length(strings));
              return discard2(modify_3(function(s) {
                ...
                return liftEffect7(renderWithTransitions(toLetters(fromMaybe("")(index(strings)(next)))));
              });
            });
          }
          ;
          throw new Error("Failed pattern match at App (line 134, column 24 - line 140, column 103): " + [v1.constructor.name]);
        },
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind15(liftEffect6(map20(toDocument)(bindFlipped7(document2)(windowImpl))))(function(document3) {
