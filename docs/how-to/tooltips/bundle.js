...
(() => {
  ...
  var onCoordinatedHighlightWithTooltip = function(config) {
    return new ThunkedCoordinatedHighlight({
      ...
      tooltipTrigger: (function() {
        if (config.tooltip instanceof Just) {
          return config.tooltip.value0.showWhen;
        }
        ;
        if (config.tooltip instanceof Nothing) {
          return OnHover.value;
        }
        ;
        throw new Error("Failed pattern match at Hylograph.HATS (line 660, column 21 - line 662, column 25): " + [config.tooltip.constructor.name]);
      })(),
      tooltipBorderColor: bind2(config.tooltip)(function(v) {
  ...
  function constrain(transform, extent, translateExtent) {
    ...
    if (dy1 > dy0) {
      y2 += (dy0 + dy1) / 2 * transform.k;
    } else if (dy0 < 0) {
      y2 -= dy0 * transform.k;
    } else if (dy1 > 0) {
      y2 -= dy1 * transform.k;
    }
    return x2 === transform.x && y2 === transform.y ? transform : new ZoomTransform(transform.k, x2, y2);
  }
  ...
  function createHatsTooltip() {
    ...
    tooltip2.className = "hats-tooltip";
  ...
  `;
    getHatsTooltipContainer().appendChild(tooltip2);
    return tooltip2;
  }
  function positionHatsTooltip(tooltip2, event) {
    const vw = window.innerWidth;
    const vh = window.innerHeight;
    const tooltipWidth = tooltip2.offsetWidth || 300;
    const tooltipHeight = tooltip2.offsetHeight || 40;
    ...
    if (y2 < 10) y2 = 10;
    tooltip2.style.left = `${x2}px`;
    tooltip2.style.top = `${y2}px`;
  }
  function showHatsTooltip(tooltip2, content3) {
    tooltip2.textContent = content3;
    tooltip2.style.opacity = "1";
  }
  function hideHatsTooltip(tooltip2) {
    if (tooltip2) {
  ...
  function applyHatsHighlightsWithTooltips(groupName, hoveredId, triggerElement, event) {
    ...
    group.forEach((entry) => {
      ...
      if (tooltipContentThunk) {
        ...
        if (shouldShow) {
          let tooltip2 = hatsElementTooltips.get(element);
          if (!tooltip2) {
            tooltip2 = createHatsTooltip();
            hatsElementTooltips.set(element, tooltip2);
          }
          const content3 = tooltipContentThunk();
          showHatsTooltip(tooltip2, content3);
          if (entry.tooltipBorderColor) {
            tooltip2.style.borderLeft = `3px solid ${entry.tooltipBorderColor}`;
          } else {
            tooltip2.style.borderLeft = "none";
          }
          if (tooltipTrigger === TT_ON_HOVER && event) {
            positionHatsTooltip(tooltip2, event);
          }
        } else {
          const tooltip2 = hatsElementTooltips.get(element);
          if (tooltip2) {
            hideHatsTooltip(tooltip2);
          }
        }
      }
    });
  ...
  function clearHatsHighlightsInGroupWithTooltips(groupName) {
    ...
    group.forEach((entry) => {
      ...
      const tooltip2 = hatsElementTooltips.get(entry.element);
      if (tooltip2) {
        hideHatsTooltip(tooltip2);
      }
    });
                    ...
                    return function(datum) {
                      ...
                      if (itemTree instanceof Elem) {
                        return function __do2() {
                          ...
                          return {
                            element: el,
                            childSelections: foldl2(union2)(empty2)(map4(function(v) {
                              return v.selections;
                            })(childMaps)),
                            transitions
                          };
            ...
            if (v instanceof MkFold) {
              return runSomeFold(v.value0)(function(foldSpec) {
                ...
                return function __do2() {
                  ...
                  var elements = map4(function(v1) {
                    return v1.element;
                  })(results);
                  var childMaps = foldl2(union2)(empty2)(map4(function(v1) {
                    return v1.childSelections;
                  })(results));
                  return {
                    selections: insert3(foldSpec.name)(elements)(childMaps),
                    entering: [catMaybes(map4(function(v1) {
            ...
            return function(v) {
              ...
              if (v instanceof MkFold) {
                return runSomeFold(v.value0)(function(spec) {
                  ...
                  var newKeys = fromFoldable4(map4(spec.keyFn)(items));
                  ...
                  return function __do2() {
                    ...
                    var existingKeys = fromFoldable4(map4(function(v1) {
                      return v1.key;
                    })(existingKeysAndEls));
                    ...
                    var updateElements = map4(function(v1) {
                      return v1.element;
                    })(filter(function(v1) {
                      return member3(v1.key)(updateKeys);
                    })(existingKeysAndEls));
                    var enterElements = map4(function(v1) {
                      return v1.element;
                    })(enterResults);
                    var childMaps = foldl2(union2)(empty2)(map4(function(v1) {
                      return v1.childSelections;
  ...
  // output/Hylograph.Tooltip/foreign.js
  var tooltip = null;
  ...
  // output/Hylograph.Tooltip/index.js
  var lightTheme = /* @__PURE__ */ (function() {
    return {
      background: new Just("rgba(255, 255, 255, 0.95)"),
      color: new Just("#333"),
      padding: new Just("8px 12px"),
      borderRadius: new Just("4px"),
      fontSize: new Just("13px"),
      fontFamily: Nothing.value,
      border: new Just("1px solid rgba(0, 0, 0, 0.1)"),
      boxShadow: new Just("0 2px 8px rgba(0, 0, 0, 0.1)"),
      maxWidth: new Just("300px"),
      lineHeight: Nothing.value,
      backdropFilter: Nothing.value
    };
  })();
  ...
  var planets = [{
    ...
    x: 130,
    y: 90,
    detail: "Hottest surface temperature"
  }, {
    name: "Earth",
    radius: 13,
    color: "#4e9fd5",
    x: 220,
    y: 100,
    detail: "The only known living world"
  }, {
    name: "Mars",
    radius: 10,
    color: "#d4644a",
    ...
    x: 430,
    y: 100,
    detail: "Largest planet in the system"
  }, {
    name: "Saturn",
    radius: 24,
    color: "#e8d88c",
    x: 550,
    y: 110,
    detail: "Famous for its rings"
  }];
  var view = /* @__PURE__ */ (function() {
    return elem2(SVG.value)([viewBox(0)(0)(640)(240), width(640), height(240)])([forEach("planets")(Group.value)(planets)(function(v) {
      return v.name;
    })(function(d) {
      return withBehaviors([onCoordinatedHighlightWithTooltip({
        identify: d.name,
        classify: function(hovered) {
          var $8 = hovered === d.name;
          if ($8) {
        ...
        tooltip: new Just({
          ...
          borderColor: new Just(d.color)
        })
      })])(elem2(Group.value)([])([elem2(Circle.value)([cx(d.x), cy(d.y), r(d.radius), fill(d.color), opacity("0.9")])([]), elem2(Text.value)([x(d.x), y(d.y + d.radius + 16), fontSize("11"), fontFamily("system-ui, sans-serif"), fill("#555"), textAnchor("middle"), staticStr("textContent")(d.name)])([])]));
    })]);
  })();
