...
(() => {
  ...
  var chart = /* @__PURE__ */ (function() {
    return elem2(SVG.value)([viewBox(0)(0)(300)(130), style("max-width: 400px;")])([forEach("bars")(Group.value)(bars)(function(v) {
      return v.label;
    })(function(d) {
      return elem2(Group.value)([])([elem2(Rect.value)([x(d.x), y(100 - d.h), width(40), height(d.h), fill(d.color)])([]), elem2(Text.value)([x(d.x + 20), y(120), textAnchor("middle"), fontSize("12px"), fill("#333"), staticStr("textContent")(d.label)])([])]);
    })]);
  })();
