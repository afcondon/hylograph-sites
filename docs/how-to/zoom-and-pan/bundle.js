...
(() => {
  ...
  var attachNativeZoom = function(element) {
    return function(config) {
      ...
      var jsConfig = {
        ...
        translateExtent: toNullable(map5(toJsExtent)(config.translateExtent)),
        onZoom: toNullable(config.onZoom)
      };
      return function __do2() {
        var jsHandle = attachNativeZoom_(element)(jsConfig)();
        return {
          getTransform: pure3(jsHandle.getTransform(unit)),
  ...
  var dots = /* @__PURE__ */ bind3(/* @__PURE__ */ range2(0)(9))(function(row) {
    return bind3(range2(0)(9))(function(col) {
      return pure4({
        row,
        col
      });
  ...
  var circleGrid = /* @__PURE__ */ (function() {
    return elem2(SVG.value)([staticStr("viewBox")("0 0 500 500"), staticStr("width")("500"), staticStr("height")("500"), staticStr("style")("background: #fff;")])([elem2(Group.value)([staticStr("class")("zoom-group")])([forEach("dots")(Circle.value)(dots)(function(d) {
      return show3(d.row) + ("," + show3(d.col));
    })(function(d) {
      return elem2(Circle.value)([staticNum("cx")(toNumber(d.col) * 45 + 50), staticNum("cy")(toNumber(d.row) * 45 + 50), staticNum("r")(12), staticStr("fill")("#4e79a7"), staticStr("opacity")("0.7")])([]);
    })])]);
  })();
  var main = function __do() {
    rerender("#app")(circleGrid)();
    var doc = bind1(windowImpl)(document2)();
    var mSvg = querySelector("#app svg")(toParentNode(doc))();
    if (mSvg instanceof Just) {
      attachZoomNative(mSvg.value0)(0.1)(10)(".zoom-group")();
      return unit;
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Main (line 66, column 3 - line 71, column 16): " + [mSvg.constructor.name]);
  };
