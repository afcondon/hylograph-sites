...
(() => {
  ...
  function attachSimpleDrag_(element) {
    return () => () => {
      ...
      function handlePointerMove(event) {
        ...
        element.setAttribute("transform", `translate(${transform2.x},${transform2.y})`);
      }
  ...
  function zoomAround(transform2, point, newK) {
    const p = transform2.invert(point);
  ...
  var scatterView = /* @__PURE__ */ (function() {
    return elem2(SVG.value)([viewBox(0)(0)(300)(230), width(300), height(230)])([forEach("scatter")(Group.value)(dots)(function(v) {
      return v.id;
    })(function(d) {
      return withBehaviors([onCoordinatedHighlight({
        identify: d.category,
        classify: function(hovered) {
          var $10 = hovered === d.category;
          if ($10) {
        ...
        group: Nothing.value
      })])(elem2(Group.value)([])([elem2(Circle.value)([cx(d.x), cy(d.y), r(d.r), fill(d.color), opacity("0.85")])([])]));
    })]);
  })();
  var categories = [{
    name: "Igneous",
  ...
  var keyView = /* @__PURE__ */ (function() {
    return elem2(SVG.value)([viewBox(0)(0)(140)(160), width(140), height(160)])([forEach("key")(Group.value)(categories)(function(v) {
      return v.name;
    })(function(cat) {
      var y2 = 10 + toNumber(cat.idx) * (28 + 8);
      return withBehaviors([onCoordinatedHighlight({
        identify: cat.name,
        classify: function(hovered) {
          var $11 = hovered === cat.name;
          if ($11) {
            return Primary.value;
          }
          ;
        ...
        group: Nothing.value
      })])(elem2(Group.value)([transform("translate(0," + (show4(y2) + ")"))])([elem2(Rect.value)([x(0), y(0), width(20), height(28), staticStr("rx")("3"), fill(cat.color)])([]), elem2(Text.value)([x(28), y(28 / 2 + 5), fontSize("13"), fontFamily("system-ui, sans-serif"), fill("#333"), staticStr("textContent")(cat.name)])([])]));
    })]);
  })();
  var main = function __do() {
    rerender("#key")(keyView)();
    rerender("#scatter")(scatterView)();
    return unit;
  };
