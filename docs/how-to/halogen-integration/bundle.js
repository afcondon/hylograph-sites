...
(() => {
            ...
            return function(phaseSpec) {
              return function(idx) {
                ...
                if (phaseSpec.transition instanceof Just) {
                  ...
                  var baseDelay = fromMaybe(0)(map13(unwrap3)(phaseSpec.transition.value0.delay));
            ...
            return function(v) {
              ...
              if (v instanceof MkFold) {
                return runSomeFold(v.value0)(function(spec) {
                  ...
                  var newKeys = fromFoldable5(map11(spec.keyFn)(items2));
  ...
  var render = function(state3) {
    return div2([class_("app")])([h1_([text("Halogen + HATS")]), p_([text("Bars: " + show3(state3.count))]), div2([class_("controls")])([button([onClick(function(v) {
      return Decrement.value;
    })])([text("\u2212")]), button([onClick(function(v) {
      return Increment.value;
    })])([text("+")])]), div2([id2("viz")])([])]);
  };
  var barChart = function(n) {
    var items2 = range2(1)(n);
    var totalWidth = toNumber(n) * (32 + 4);
    return elem2(SVG.value)([staticNum("width")(totalWidth), staticNum("height")(200 + 20), staticStr("viewBox")("0 0 " + (show1(totalWidth) + (" " + show1(200 + 20))))])([forEach("bars")(Rect.value)(items2)(show3)(function(i2) {
      var x = toNumber(i2 - 1 | 0) * (32 + 4);
      var h = 200 * toNumber(i2) / toNumber(n);
      var y = 200 - h;
      return elem2(Rect.value)([thunkedNum("x")(x), thunkedNum("y")(y), thunkedNum("width")(32), thunkedNum("height")(h), thunkedStr("fill")("#2563eb"), thunkedNum("rx")(2)])([]);
    })]);
  };
  var renderViz = function(n) {
    return function __do2() {
      clearElement("#viz")();
      rerender("#viz")(barChart(n))();
      return unit;
    };
  };
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind12(get2)(function(state3) {
          return liftEffect7(renderViz(state3.count));
        });
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at App (line 57, column 16 - line 68, column 41): " + [v.constructor.name]);
    };
  };
