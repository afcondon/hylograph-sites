...
(() => {
  ...
  var attachCoordinatedBrushThunked = (element) => (extent) => (groupName) => () => {
    ...
    element.addEventListener("pointermove", function(event) {
      ...
      const box = { x0: x3, y0: y3, x1: x3 + width9, y1: y3 + height8 };
  ...
  var chart = /* @__PURE__ */ (function() {
    var yS = range3([10 + 300, 10])(domain([0, 100])(linear2));
    var yT = ticks(5)(yS);
    var w = 50 + 440 + 10;
    var xS = range3([50, 50 + 440])(domain([0, 100])(linear2));
    var xT = ticks(5)(xS);
    var h = 10 + 300 + 40;
    var bY = 10 + 300;
    return elem2(SVG.value)([viewBox(0)(0)(w)(h), width(w), style("max-width: 520px; font-family: system-ui, sans-serif;")])([forEach("pts")(Circle.value)(points)(function(v) {
      return v.label;
    })(function(pt) {
      return elem2(Circle.value)([cx(applyScale(xS)(pt.x)), cy(applyScale(yS)(pt.y)), r(4), fill("#2563eb"), fillOpacity("0.7")])([]);
    }), elem2(Line.value)([x1(50), y1(bY), x2(50 + 440), y2(bY), stroke("#333"), strokeWidth(1)])([]), forEach("xTicks")(Group.value)(xT)(show4)(function(tv) {
      var px = applyScale(xS)(tv);
      return elem2(Group.value)([])([elem2(Line.value)([x1(px), y1(bY), x2(px), y2(bY + 6), stroke("#333"), strokeWidth(1)])([]), elem2(Text.value)([x(px), y(bY + 20), textAnchor("middle"), fontSize("11"), fill("#555"), staticStr("textContent")(show4(tv))])([])]);
    }), elem2(Line.value)([x1(50), y1(10), x2(50), y2(10 + 300), stroke("#333"), strokeWidth(1)])([]), forEach("yTicks")(Group.value)(yT)(show4)(function(tv) {
      var py = applyScale(yS)(tv);
      return elem2(Group.value)([])([elem2(Line.value)([x1(50 - 6), y1(py), x2(50), y2(py), stroke("#333"), strokeWidth(1)])([]), elem2(Text.value)([x(50 - 10), y(py + 4), textAnchor("end"), fontSize("11"), fill("#555"), staticStr("textContent")(show4(tv))])([])]);
    })]);
  })();
