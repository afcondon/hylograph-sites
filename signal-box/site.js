...
(() => {
            ...
            return function(array) {
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  case 2:
                    return apply7(map33(array2)(f(array[bot])))(f(array[bot + 1]));
                  case 3:
                    return apply7(apply7(map33(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top2 - bot) / 4) * 2;
                    return apply7(map33(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
  ...
  var evalQ = function(render8) {
    return function(ref2) {
      return function(q2) {
        return bind12(liftEffect4(read(ref2)))(function(v) {
          return evalM(render8)(ref2)(v["component"]["eval"](new Query(map13(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
                      ...
                      if (childrenIn instanceof Just) {
                        ...
                        unDriverStateX(function(st) {
                          return function __do3() {
                            ...
                            return handleAff(evalM(render8)(st.selfRef)(st["component"]["eval"](new Receive(slot.input, unit))))();
                          };
                        })(dsx)();
  ...
  var rerenderTree = function(doc) {
    return function(parent2) {
      return function(tree3) {
            ...
            return function(phaseSpec) {
              return function(idx) {
                ...
                if (phaseSpec.transition instanceof Just) {
                  ...
                  var baseDelay = fromMaybe(0)(map19(unwrap4)(phaseSpec.transition.value0.delay));
                    ...
                    return function(datum) {
                      ...
                      if (itemTree instanceof Elem2) {
                        return function __do2() {
                          ...
                          return {
                            element: el,
                            childSelections: foldl2(union3)(empty2)(map18(function(v) {
                              return v.selections;
                            })(childMaps)),
                            transitions
                          };
            ...
            if (v instanceof MkFold) {
              return runSomeFold(v.value0)(function(foldSpec) {
                ...
                return function __do2() {
                  ...
                  var elements = map18(function(v1) {
                    return v1.element;
                  })(results);
                  var childMaps = foldl2(union3)(empty2)(map18(function(v1) {
                    return v1.childSelections;
                  })(results));
                  return {
                    selections: insert5(foldSpec.name)(elements)(childMaps),
                    entering: [catMaybes(map18(function(v1) {
            ...
            return function(v) {
              ...
              if (v instanceof MkFold) {
                return runSomeFold(v.value0)(function(spec) {
                  ...
                  var newKeys = fromFoldable5(map18(spec.keyFn)(items2));
                  ...
                  return function __do2() {
                    ...
                    var existingKeys = fromFoldable5(map18(function(v1) {
                      return v1.key;
                    })(existingKeysAndEls));
                    ...
                    var updateElements = map18(function(v1) {
                      return v1.element;
                    })(filter(function(v1) {
                      return member3(v1.key)(updateKeys);
                    })(existingKeysAndEls));
                    var enterElements = map18(function(v1) {
                      return v1.element;
                    })(enterResults);
                    var childMaps = foldl2(union3)(empty2)(map18(function(v1) {
                      return v1.childSelections;
                    })(enterResults));
                    var selections = insert5(spec.name)(append5(updateElements)(enterElements))(childMaps);
        ...
        return function __do2() {
          var v = goWithDomIdx(parent2)(0)(tree3)();
  ...
  var rerender = function(selector) {
    return function(tree3) {
      return function __do2() {
        ...
        return rerenderTree(doc)(container)(tree3)();
      };
    };
  };
  ...
  var elem4 = /* @__PURE__ */ elem2(eqSegmentId);
  var eqRoute = {
    eq: function(x) {
      return function(y) {
  ...
  var renderSignal = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at SignalBox.World (line 95, column 16 - line 99, column 15): " + [v.constructor.name]);
  };
  ...
  var elem5 = /* @__PURE__ */ elem2(eqRoute);
  ...
  var eq12 = /* @__PURE__ */ eq(eqTrainId);
  ...
  var renderViolation = function(v) {
    if (v instanceof Collision) {
      return "collision: two trains in segment " + renderSegment(v.value0);
    }
    ;
    if (v instanceof Bilocation) {
      return "bilocation: " + (renderTrain(v.value0) + " in two segments at once");
    }
    ;
    if (v instanceof PointsAgainstRoute) {
      return "derailment: " + (renderSignal(v.value0) + (" green but points set against " + renderRoute(v.value0)));
    }
    ;
    if (v instanceof ConflictingRoutes) {
      return "conflict: " + (renderSignal(v.value0) + (" and " + (renderSignal(v.value1) + (" both green (" + (renderRoute(v.value0) + (" vs " + (renderRoute(v.value1) + ")")))))));
    }
    ;
    if (v instanceof GreenIntoOccupied) {
      return "green into occupied track: " + (renderSignal(v.value0) + (" cleared toward occupied " + renderSegment(routeDest(v.value0))));
    }
    ;
    throw new Error("Failed pattern match at SignalBox.Oracle (line 53, column 19 - line 65, column 68): " + [v.constructor.name]);
  };
  var rawKey = function(raw) {
    ...
    return joinWith("|")([joinWith("")(map20(greenBit)(allRoutes)), renderPoints(raw.p1), renderPoints(raw.p2), joinWith(",")(sort2(map20(occKey)(nubEq3(raw.occupancy))))]);
  };
  var orderedPairs = function(xs) {
    ...
    ;
    if (v instanceof Just) {
      return append12(map20(Tuple.create(v.value0.head))(v.value0.tail))(orderedPairs(v.value0.tail));
    }
    ;
  ...
  var check = function(raw) {
    ...
    var collisions = mapMaybe(function(seg) {
      var $48 = length(nubEq1(trainsAt(seg))) >= 2;
      if ($48) {
    ...
    var bilocations = mapMaybe(function(t) {
      var $49 = length(nubEq22(segsOf(t))) >= 2;
      if ($49) {
  ...
  var countDistinct = function(keys4) {
    var sorted = sort3(keys4);
    var changes = length(filter(identity9)(zipWith(function(x) {
      return function(y) {
        return x !== y;
      };
  ...
  var auditRung = function(spec) {
    ...
    var step3 = function(a2) {
      return function(st) {
        ...
        if (v instanceof Just) {
          ...
          ;
          var present = nubEq4(map21(classOf)(v1));
          var counted = foldl3(function(a$prime) {
            return function(c) {
    ...
    var acc = foldl3(step3)(initial)(spec.states);
    return {
      name: spec.name,
      technique: spec.technique,
      spaceNote: spec.spaceNote,
      total: length(spec.states),
  ...
  var render = function(s) {
    ...
    return "sa=" + (q2(s.sa) + (" sl=" + (q2(s.sl) + (" se=" + (q2(s.se) + (" sm=" + (q2(s.sm) + (" p1=" + (show3(s.p1) + (" p2=" + (show3(s.p2) + (" t1=" + (q2(s.t1) + (" t2=" + q2(s.t2)))))))))))))));
  };
  ...
  var toRaw = function(s) {
    return bind6(parseAspect(s.sa))(function(saG) {
      return bind6(parseAspect(s.sl))(function(slG) {
        return bind6(parseAspect(s.se))(function(seG) {
          return bind6(parseAspect(s.sm))(function(smG) {
            return bind6(parsePosition(s.t1))(function(t1) {
              return bind6(parsePosition(s.t2))(function(t2) {
                return pure10({
                  ...
                  p1: parsePoints(s.p1),
                  p2: parsePoints(s.p2),
                  occupancy: catMaybes([map25(function(seg) {
                    return {
                      seg,
                      train: T1.value
                    };
                  })(t1), map25(function(seg) {
                    return {
                      seg,
                      train: T2.value
                    };
  ...
  var states3 = /* @__PURE__ */ (function() {
    ...
    return apply4(apply4(apply4(apply4(apply4(apply4(apply4(map27(mk)(bools))(bools))(bools))(bools))(allPointsPos))(allPointsPos))(allPositions))(allPositions);
  })();
  ...
  var render3 = function(s) {
    return "want={" + (joinWith(",")(map27(renderRoute)(requested(s))) + ("}" + (" p1=" + (renderPoints(s.p1) + (" p2=" + (renderPoints(s.p2) + (" t1=" + (renderPosition(s.t1) + (" t2=" + renderPosition(s.t2))))))))));
  };
  ...
  var toRaw4 = function(s) {
    return new Just({
      ...
      p1: s.p1,
      p2: s.p2,
      occupancy: catMaybes([map28(function(seg) {
        return {
          seg,
          train: T1.value
        };
      })(s.t1), map28(function(seg) {
        return {
          seg,
          train: T2.value
        };
  ...
  var rawOf = function(s) {
    return {
      ...
      p1: s.p1,
      p2: s.p2,
      occupancy: catMaybes([map29(function(seg) {
        return {
          seg,
          train: T1.value
        };
      })(s.t1), map29(function(seg) {
        return {
          seg,
          train: T2.value
        };
  ...
  // output/Webapp.Dom/foreign.js
  var setHtmlImpl = (sel) => (html2) => () => {
    const el = document.querySelector(sel);
    if (el) el.innerHTML = html2;
  };

  // output/Webapp.Dom/index.js
  var setHtml = setHtmlImpl;

  // output/Webapp.Specimens/index.js
  var snippet4 = `<div class="specimen-stack"><section class="row kind-data kind-newtype"><span class="label">Newtype</span><span class="name">State</span><div class="ctor-line"><span class="ctor-sep">=</span><span class="ctor-body"><span class="ctor-name">State</span></span></div><pre class="defn-body">  { locked :: Locked
  , p1 :: PointsPos, p2 :: PointsPos
  , t1 :: Maybe SegmentId, t2 :: Maybe SegmentId
  }</pre><div class="marginalia"><p class="can-dropcap">v4: parse, don't validate. The remaining failure families tie routes to occupancy. So the type is opaque and the only door is total.</p></div></section><section class="row kind-value"><span class="label">Function</span><span class="name">make</span><span class="sep">::</span><span class="type"><div class="sig-stack"><span class="sig-station-body">Locked</span><span class="sig-station-op sig-op-arrow"><span class="g">\u2192</span></span><span class="sig-station-body">PointsPos</span><span class="sig-station-op sig-op-arrow"><span class="g">\u2192</span></span><span class="sig-station-body">PointsPos</span><span class="sig-station-op sig-op-arrow"><span class="g">\u2192</span></span><span class="sig-station-body">Maybe SegmentId</span><span class="sig-station-op sig-op-arrow"><span class="g">\u2192</span></span><span class="sig-station-body">Maybe SegmentId</span><span class="sig-station-op sig-op-arrow"><span class="g">\u2192</span></span><span class="sig-station-body">Either (Array Violation) State</span><span class="sig-station-op"></span></div></span><div class="value-body"><span class="name">make locked p1 p2 t1 t2</span><span class="sep">=</span><span class="type">validate (State { locked, p1, p2, t1, t2 })</span></div></section></div>`;
  var snippet3 = '<div class="specimen-stack"><section class="row kind-data"><span class="label">Data</span><span class="name">Locked</span><div class="ctor-line"><span class="ctor-sep">=</span><span class="ctor-body"><span class="ctor-name">NoneSet</span></span></div><div class="ctor-line"><span class="ctor-sep">|</span><span class="ctor-body"><span class="ctor-name">One</span> <span class="ctor-args">Route</span></span></div><div class="ctor-line"><span class="ctor-sep">|</span><span class="ctor-body"><span class="ctor-name">PassEntry</span><span class="ctor-comment">A\u2192L together with E\u2192M: two trains enter to pass</span></span></div><div class="ctor-line"><span class="ctor-sep">|</span><span class="ctor-body"><span class="ctor-name">PassExit</span><span class="ctor-comment">L\u2192E together with M\u2192A: two trains depart after passing</span></span></div><div class="marginalia"><p class="can-dropcap">v3: the locking table as a type. Legal combinations of routes are a closed sum: the constructor for "conflicting greens" does not exist.</p></div></section><section class="row kind-type"><span class="label">Type</span><span class="name">State</span><span class="sep">=</span><span class="type"></span><pre class="defn-body">  { locked :: Locked\n  , p1 :: PointsPos, p2 :: PointsPos\n  , t1 :: Maybe SegmentId, t2 :: Maybe SegmentId\n  }</pre></section></div>';
  var snippet2 = `<div class="specimen-stack"><section class="row kind-type"><span class="label">Type</span><span class="name">State</span><span class="sep">=</span><span class="type"></span><pre class="defn-body">  { wantAL :: Boolean, wantLE :: Boolean, wantEM :: Boolean, wantMA :: Boolean
  , p1 :: PointsPos, p2 :: PointsPos
  , t1 :: Maybe SegmentId, t2 :: Maybe SegmentId
  }</pre><div class="marginalia"><p class="can-dropcap">v2: derive, don't store. Signals are outputs of the lever frame, not lamps somebody sets. A derived aspect can't contradict the points.</p></div></section><section class="row kind-value"><span class="label">Function</span><span class="name">greens</span><span class="sep">::</span><span class="type">State <span class="g">\u2192</span> Array Route</span><div class="value-body"><span class="name">greens s</span><span class="sep">=</span><span class="type">filter (\\r <span class="g">\u2192</span> leverFor r s == requiredBy r) (requested s)</span></div></section></div>`;
  var snippet1 = '<div class="specimen-stack"><section class="row kind-data"><span class="label">Data</span><span class="name">Aspect</span><div class="ctor-line"><span class="ctor-sep">=</span><span class="ctor-body"><span class="ctor-name">Red</span></span></div><div class="ctor-line"><span class="ctor-sep">|</span><span class="ctor-body"><span class="ctor-name">Green</span></span></div><div class="marginalia marginalia-compact"><p class="can-dropcap">v1: name your atoms. Closed vocabularies; absence is Maybe, not "".</p></div></section><section class="row kind-data"><span class="label">Data</span><span class="name">PointsPos</span><div class="ctor-line"><span class="ctor-sep">=</span><span class="ctor-body"><span class="ctor-name">ToLoop</span></span></div><div class="ctor-line"><span class="ctor-sep">|</span><span class="ctor-body"><span class="ctor-name">ToMain</span></span></div></section><section class="row kind-data"><span class="label">Data</span><span class="name">SegmentId</span><div class="ctor-line"><span class="ctor-sep">=</span><span class="ctor-body"><span class="ctor-name">SegA</span></span></div><div class="ctor-line"><span class="ctor-sep">|</span><span class="ctor-body"><span class="ctor-name">SegL</span></span></div><div class="ctor-line"><span class="ctor-sep">|</span><span class="ctor-body"><span class="ctor-name">SegM</span></span></div><div class="ctor-line"><span class="ctor-sep">|</span><span class="ctor-body"><span class="ctor-name">SegE</span></span></div></section><section class="row kind-type"><span class="label">Type</span><span class="name">State</span><span class="sep">=</span><span class="type"></span><pre class="defn-body">  { sa :: Aspect, sl :: Aspect, se :: Aspect, sm :: Aspect\n  , p1 :: PointsPos, p2 :: PointsPos\n  , t1 :: Maybe SegmentId, t2 :: Maybe SegmentId\n  }</pre></section></div>';
  var snippet0 = '<div class="specimen-stack"><section class="row kind-type"><span class="label">Type</span><span class="name">State</span><span class="sep">=</span><span class="type"></span><pre class="defn-body">  { sa :: String, sl :: String, se :: String, sm :: String   -- "G"? "green"? "g"? ""?\n  , p1 :: Boolean, p2 :: Boolean    -- true means... toward the loop? (check the wiki)\n  , t1 :: String, t2 :: String      -- segment name, "" when off-scene, typos welcome\n  }</pre><div class="marginalia marginalia-compact"><p class="can-dropcap">v0: the state, as too many codebases keep it.</p></div></section></div>';
  var snippetFor = function(n) {
    if (n === 0) {
      return snippet0;
    }
    ;
  ...
  // output/Webapp.Viz.Junction/index.js
  var elem6 = /* @__PURE__ */ elem2(eqRoute);
  var eq9 = /* @__PURE__ */ eq(eqSegmentId);
  var show4 = /* @__PURE__ */ show(showNumber);
  var tracks = /* @__PURE__ */ (function() {
    var label5 = function(txt) {
      return function(x) {
        return function(y) {
          return elem3(Text2.value)([staticNum("x")(x), staticNum("y")(y), staticStr("text-anchor")("middle"), staticNum("font-size")(12), staticStr("fill")("#9a9a94"), staticStr("textContent")(txt)])([]);
        };
      };
    };
    return elem3(Group.value)([staticStr("class")("tracks")])([elem3(Path.value)([staticStr("d")("M 30 120 L 770 120"), staticStr("stroke")("#c9c9c4"), staticNum("stroke-width")(4), staticStr("fill")("none")])([]), elem3(Path.value)([staticStr("d")("M 250 120 L 330 60 L 530 60 L 610 120"), staticStr("stroke")("#c9c9c4"), staticNum("stroke-width")(4), staticStr("fill")("none")])([]), label5("A")(140)(140), label5("L")(430)(48), label5("M")(430)(140), label5("E")(690)(140), label5("P1")(244)(166), label5("P2")(616)(166)]);
  })();
  var signalStem = function(v) {
    if (v instanceof AtoL) {
      return {
        x: 222,
        y: 120
    ...
    ;
    throw new Error("Failed pattern match at Webapp.Viz.Junction (line 51, column 14 - line 55, column 33): " + [v.constructor.name]);
  };
  var signalPos = function(v) {
    if (v instanceof AtoL) {
      return {
        x: 222,
        y: 92
    ...
    ;
    throw new Error("Failed pattern match at Webapp.Viz.Junction (line 44, column 13 - line 48, column 33): " + [v.constructor.name]);
  };
  var signals = function(raw) {
    return forEach("signals")(Group.value)(allRoutes)(renderSignal)(function(r) {
      var pos = signalPos(r);
      var green = elem6(r)(raw.greens);
      var base2 = signalStem(r);
      return elem3(Group.value)([])([elem3(Line.value)([staticNum("x1")(base2.x), staticNum("y1")(base2.y), staticNum("x2")(pos.x), staticNum("y2")(pos.y), staticStr("stroke")("#8a8a84"), staticNum("stroke-width")(1.5)])([]), elem3(Circle.value)([staticNum("cx")(pos.x), staticNum("cy")(pos.y), staticNum("r")(8), thunkedStr("fill")((function() {
        if (green) {
          return "#2e7d32";
        }
        ;
        return "#d64545";
      })()), staticStr("stroke")("#1f1f1d"), staticNum("stroke-width")(1.5)])([]), elem3(Text2.value)([staticNum("x")(pos.x + 14), staticNum("y")(pos.y + 4), staticNum("font-size")(11), staticStr("fill")("#9a9a94"), staticStr("textContent")(renderSignal(r))])([])]);
    });
  };
  var segExtent = function(v) {
    if (v instanceof SegA) {
      return {
        x1: 30,
        x2: 250,
    ...
    ;
    throw new Error("Failed pattern match at Webapp.Viz.Junction (line 37, column 13 - line 41, column 45): " + [v.constructor.name]);
  };
  var segCenter = function(v) {
    if (v instanceof SegA) {
      return {
        x: 140,
        y: 120
    ...
    ;
    throw new Error("Failed pattern match at Webapp.Viz.Junction (line 30, column 13 - line 34, column 33): " + [v.constructor.name]);
  };
  var trains = function(raw) {
    var place = function(i2) {
      return function(o) {
        var clash = length(filter(function(p2) {
          return eq9(p2.seg)(o.seg);
        })(raw.occupancy)) >= 2;
        var dx = (function() {
          var $21 = !clash;
          if ($21) {
    ...
    var positioned = mapWithIndex2(place)(raw.occupancy);
    return forEach("trains")(Group.value)(positioned)(function(t) {
      return renderTrain(t.train);
    })(function(t) {
      return elem3(Group.value)([thunkedStr("transform")("translate(" + (show4(t.x - 22) + ("," + (show4(t.y - 9) + ")"))))])([elem3(Rect.value)([staticNum("width")(44), staticNum("height")(18), staticNum("rx")(4), staticStr("fill")("#1f1f1d")])([]), elem3(Text2.value)([staticNum("x")(22), staticNum("y")(13), staticStr("text-anchor")("middle"), staticNum("font-size")(10), staticStr("fill")("#fafaf8"), thunkedStr("textContent")(renderTrain(t.train))])([])]);
    });
  };
  var leverPt = function(v) {
    if (v instanceof P1) {
      return {
        x: 250,
        y: 120
    ...
    ;
    throw new Error("Failed pattern match at Webapp.Viz.Junction (line 58, column 11 - line 60, column 31): " + [v.constructor.name]);
  };
  var overlays = function(violations) {
    var shapes = function(v) {
      if (v instanceof Collision) {
        var c = segCenter(v.value0);
        return [elem3(Circle.value)([staticNum("cx")(c.x), staticNum("cy")(c.y), staticNum("r")(38), staticStr("fill")("none"), staticStr("stroke")("#d64545"), staticNum("stroke-width")(2.5), staticStr("stroke-dasharray")("6,4")])([])];
      }
      ;
      if (v instanceof Bilocation) {
        return [];
      ...
      ;
      if (v instanceof PointsAgainstRoute) {
        var p2 = leverPt(routeLever(v.value0));
        return [elem3(Text2.value)([staticNum("x")(p2.x), staticNum("y")(p2.y - 14), staticStr("text-anchor")("middle"), staticNum("font-size")(22), staticStr("fill")("#d64545"), staticStr("font-weight")("bold"), staticStr("textContent")("\u2715")])([])];
      }
      ;
      if (v instanceof ConflictingRoutes) {
        var b2 = signalPos(v.value1);
        var a2 = signalPos(v.value0);
        return [elem3(Line.value)([staticNum("x1")(a2.x), staticNum("y1")(a2.y), staticNum("x2")(b2.x), staticNum("y2")(b2.y), staticStr("stroke")("#d64545"), staticNum("stroke-width")(2), staticStr("stroke-dasharray")("5,5")])([])];
      }
      ;
      if (v instanceof GreenIntoOccupied) {
        var e = segExtent(routeDest(v.value0));
        return [elem3(Line.value)([staticNum("x1")(e.x1), staticNum("y1")(e.y), staticNum("x2")(e.x2), staticNum("y2")(e.y), staticStr("stroke")("#d64545"), staticNum("stroke-width")(12), staticStr("stroke-linecap")("round"), staticNum("opacity")(0.25)])([])];
      }
      ;
      throw new Error("Failed pattern match at Webapp.Viz.Junction (line 217, column 12 - line 277, column 10): " + [v.constructor.name]);
    };
    return forEach("violations")(Group.value)(violations)(renderViolation)(function(v) {
      return elem3(Group.value)([staticStr("class")("violation-overlay")])(shapes(v));
    });
  };
  var blades = function(raw) {
    var blade = function(from3) {
      return function(loopEnd) {
        return function(mainEnd) {
          return function(pos) {
            return elem3(Group.value)([])([elem3(Line.value)([staticNum("x1")(from3.x), staticNum("y1")(from3.y), thunkedNum("x2")((function() {
              if (pos instanceof ToLoop) {
                return loopEnd.x;
              }
              ;
              if (pos instanceof ToMain) {
                return mainEnd.x;
              }
              ;
              throw new Error("Failed pattern match at Webapp.Viz.Junction (line 125, column 30 - line 126, column 61): " + [pos.constructor.name]);
            })()), thunkedNum("y2")((function() {
              if (pos instanceof ToLoop) {
                return loopEnd.y;
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at Webapp.Viz.Junction (line 127, column 30 - line 128, column 61): " + [pos.constructor.name]);
            })()), staticStr("stroke")("#1f1f1d"), staticNum("stroke-width")(5), staticStr("stroke-linecap")("round")])([])]);
          };
        };
      };
    };
    return elem3(Group.value)([staticStr("class")("blades")])([blade(leverPt(P1.value))({
      x: 298,
      y: 84
    })({
      x: 312,
      y: 120
    })(raw.p1), blade(leverPt(P2.value))({
      x: 562,
      y: 84
    })({
      x: 548,
  ...
  var tree = function(raw) {
    return function(violations) {
      return elem3(SVG.value)([staticStr("viewBox")("0 0 800 190"), staticStr("class")("junction")])([tracks, blades(raw), signals(raw), trains(raw), overlays(violations)]);
    };
  };

  // output/Webapp.Viz.StateGrid/index.js
  ...
  var verdictRank = function(v) {
    if (v instanceof Just && v.value0 instanceof ClassDerailment) {
      return 0;
    }
    ;
    if (v instanceof Just && v.value0 instanceof ClassConflict) {
      return 1;
    }
    ;
    if (v instanceof Just && v.value0 instanceof ClassCollision) {
      return 2;
    }
    ;
    if (v instanceof Just && v.value0 instanceof ClassIntoOccupied) {
      return 3;
    }
    ;
    if (v instanceof Just && v.value0 instanceof ClassMalformed) {
      return 4;
    }
    ;
    if (v instanceof Just && v.value0 instanceof ClassBilocation) {
      return 4;
    }
    ;
    if (v instanceof Nothing) {
    ...
    ;
    throw new Error("Failed pattern match at Webapp.Viz.StateGrid (line 58, column 15 - line 65, column 15): " + [v.constructor.name]);
  };
  var unreachable = "#ebebe8";
  var reachSets = /* @__PURE__ */ (function() {
    var mk = function(sts) {
      return function(toRaw6) {
        return fromFoldable6(map30(rawKey)(mapMaybe(toRaw6)(sts)));
      };
    };
    var v1Set = mk(states2)(toRaw2);
    return [v1Set, v1Set, mk(states3)(toRaw3), mk(states4)(toRaw4), mk(states5)(toRaw5)];
  })();
  var colorFor = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Webapp.Viz.StateGrid (line 34, column 12 - line 41, column 36): " + [v.constructor.name]);
  };
  var cells2 = /* @__PURE__ */ (function() {
    var place = function(i2) {
      return function(f) {
        return {
          key: f.key,
          x: toNumber(mod2(i2)(40)) * 14,
          y: toNumber(div3(i2)(40)) * 14,
          color: colorFor(f.verdict)
        };
      };
    };
    var describe = function(raw) {
      return {
        key: rawKey(raw),
        verdict: map111(classOf)(head(check(raw)))
      };
    };
    var fact = function(st) {
      return map111(describe)(toRaw2(st));
    };
    var facts = mapMaybe(fact)(states2);
    var sorted = sortBy(append(semigroupFn(semigroupFn(semigroupOrdering)))(comparing(ordInt)(function($34) {
      return verdictRank((function(v) {
        return v.verdict;
      })($34));
    }))(comparing(ordString)(function(v) {
      return v.key;
    })))(facts);
    return mapWithIndex2(place)(sorted);
  })();
  var tree2 = function(reach) {
    return elem3(SVG.value)([staticStr("viewBox")("0 0 558 558"), staticStr("class")("state-grid")])([forEach("cells")(Rect.value)(cells2)(function(v) {
      return v.key;
    })(function(c) {
      return elem3(Rect.value)([thunkedNum("x")(c.x), thunkedNum("y")(c.y), staticNum("width")(12), staticNum("height")(12), staticNum("rx")(1.5), thunkedStr("fill")((function() {
        var $33 = member4(c.key)(reach);
        if ($33) {
          return c.color;
        }
        ;
  ...
  var V0Only = /* @__PURE__ */ (function() {
    function V0Only2() {
    }
    ;
    V0Only2.value = new V0Only2();
    return V0Only2;
  })();
  ...
  var SelectRung = /* @__PURE__ */ (function() {
    function SelectRung2(value0) {
      this.value0 = value0;
    }
    ;
    SelectRung2.create = function(value0) {
      return new SelectRung2(value0);
    };
    return SelectRung2;
  })();
  var SelectExample = /* @__PURE__ */ (function() {
    function SelectExample2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    SelectExample2.create = function(value0) {
      return function(value1) {
        return new SelectExample2(value0, value1);
      };
    };
    return SelectExample2;
  })();
  var rungNav = function(active) {
    var rungButton = function(i2) {
      return function(a2) {
        return button([classes(map31(ClassName)((function() {
          var $38 = i2 === active;
          if ($38) {
            return ["rung", "active"];
          }
          ...
          return new SelectRung(i2);
        })])([span3([class_("rung-name")])([text5(a2.name)]), span3([class_("rung-technique")])([text5(a2.technique)])]);
      };
    };
    return nav([class_("rungs")])(mapWithIndex2(function(i2) {
      return function(a2) {
        return rungButton(i2)(a2);
      };
    })(audits));
  };
  var redrawJunction = function(dictMonadEffect) {
    var liftEffect8 = liftEffect(monadEffectHalogenM(dictMonadEffect));
    return function(sel) {
      return liftEffect8($$void9(rerender("#junction")(tree(sel.raw)(check(sel.raw)))));
    };
  };
  var redrawGrid = function(dictMonadEffect) {
    var liftEffect8 = liftEffect(monadEffectHalogenM(dictMonadEffect));
    return function(i2) {
      return liftEffect8($$void9(rerender("#state-grid")(tree2(fromMaybe(empty7)(index(reachSets)(i2))))));
    };
  };
  var junctionPane = function(st) {
    var verdict = function(vs) {
      var v = map31(renderViolation)(vs);
      if (v.length === 0) {
        return p([class_("verdict-ok")])([text5("\u2713 legal: the oracle finds nothing")]);
      }
      ;
      return ul([class_("verdict-bad")])(map31(function(msg) {
        return li_([text5(msg)]);
      })(v));
    };
    return section([class_("junction-pane")])([h2_([text5("The junction")]), p([class_("caption")])([text5(st.selected.caption)]), div2([id2("junction")])([]), verdict(check(st.selected.raw))]);
  };
  var injectCode = function(dictMonadEffect) {
    var liftEffect8 = liftEffect(monadEffectHalogenM(dictMonadEffect));
    return function(i2) {
      return liftEffect8(setHtml("#code-pane")(snippetFor(i2)));
    };
  };
  var header2 = /* @__PURE__ */ header_([/* @__PURE__ */ nav([/* @__PURE__ */ class_("page-nav")])([/* @__PURE__ */ a([/* @__PURE__ */ href4("index.html")])([/* @__PURE__ */ text5("MISU")]), /* @__PURE__ */ a([/* @__PURE__ */ href4("domain.html")])([/* @__PURE__ */ text5("Domain")]), /* @__PURE__ */ span3([/* @__PURE__ */ class_("page-nav-current")])([/* @__PURE__ */ text5("Types")]), /* @__PURE__ */ a([/* @__PURE__ */ href4("evaluation.html")])([/* @__PURE__ */ text5("Results")]), /* @__PURE__ */ a([/* @__PURE__ */ href4("payoff.html")])([/* @__PURE__ */ text5("Extension")])])]);
  var handleAction = function(dictMonadEffect) {
    var redrawJunction1 = redrawJunction(dictMonadEffect);
    var redrawGrid1 = redrawGrid(dictMonadEffect);
    var injectCode1 = injectCode(dictMonadEffect);
    return function(v) {
      if (v instanceof Initialize2) {
        return bind7(get2)(function(st) {
          return discard4(redrawJunction1(st.selected))(function() {
            if (st.mode instanceof V0Only) {
              return redrawGrid1(st.rung);
            }
            ;
            if (st.mode instanceof Full) {
              return injectCode1(st.rung);
            }
            ;
            throw new Error("Failed pattern match at Webapp.App (line 78, column 5 - line 80, column 33): " + [st.mode.constructor.name]);
          });
        });
      }
      ;
      if (v instanceof SelectRung) {
      ...
      if (v instanceof SelectExample) {
        ...
        return discard4(modify_3(function(v1) {
          ...
          return redrawJunction1(sel);
        });
      }
      ;
      throw new Error("Failed pattern match at Webapp.App (line 74, column 16 - line 89, column 23): " + [v.constructor.name]);
    };
  };
  var gridPane = function(i2) {
    var item = function(color) {
      return function(lbl) {
        return span3([class_("legend-item")])([span3([class_("swatch"), style("background:" + color)])([]), text5(lbl)]);
      };
    };
    var legend2 = div2([class_("legend")])([item("#2e7d32")("safe"), item("#e09f3e")("derailment"), item("#d64545")("conflicting greens"), item("#9e4f9e")("collision"), item("#5b7db1")("green into occupied"), item("#ebebe8")("unrepresentable at this rung")]);
    return section([class_("grid-pane")])([h2_([text5("The physical state space")]), p([class_("caption")])([text5("All 1,600 physically-expressible configurations, fixed positions. Colored = this rung can represent it; pale = unrepresentable here." + (function() {
      var $51 = i2 === 0;
      if ($51) {
        return " (v0 additionally represents 88,400 malformed states that aren't on this canvas at all.)";
      }
      ;
      return "";
    })())]), div2([id2("state-grid")])([]), legend2]);
  };
  var footer2 = /* @__PURE__ */ footer_([/* @__PURE__ */ p_([/* @__PURE__ */ text5("Your browser computed this page with the same pure PureScript core that produced the Node, Python, and Julia reports on the payoff page. The numbers match those runtimes byte for byte, and the agreement costs nothing: exhaustive enumeration over plain algebraic data types, with no seeds or emulation layer to maintain.")])]);
  var exemplar = /* @__PURE__ */ (function() {
    return {
      caption: "Legal exemplar, the pass-entry move: T1 enters the loop while T2 takes the main, and both signals show green lawfully.",
      raw: {
        greens: [AtoL.value, EtoM.value],
        p1: ToLoop.value,
        p2: ToMain.value,
        occupancy: [{
          seg: SegA.value,
  ...
  var galleryPane = function(i2) {
    var exampleButtons = function(a2) {
      return mapMaybe(function(cc) {
        if (cc.exampleRaw instanceof Nothing) {
          return Nothing.value;
        }
        ;
        if (cc.exampleRaw instanceof Just) {
          return new Just(button([class_("example"), onClick(function(v2) {
            return new SelectExample(classLabel(cc.cls) + (", first counterexample at " + fromMaybe("")(map112(function(v1) {
              return v1.name;
            })(index(audits)(i2)))), cc.exampleRaw.value0);
          })])([span3([class_("example-label")])([text5(classLabel(cc.cls))]), span3([class_("example-count")])([text5(show5(cc.count))])]));
        }
        ;
        throw new Error("Failed pattern match at Webapp.App (line 222, column 5 - line 233, column 12): " + [cc.exampleRaw.constructor.name]);
      })(a2.classes);
    };
    var v = index(audits)(i2);
    if (v instanceof Nothing) {
      return text5("");
    }
    ;
    if (v instanceof Just) {
      return section([class_("gallery")])([h2_([text5("Counterexamples")]), p([class_("caption")])([text5("The canonical first counterexample per family: first in enumeration order, identical on each runtime.")]), div2([class_("gallery-buttons")])(append13(exampleButtons(v.value0))([button([class_("example legal"), onClick(function(v1) {
        return new SelectExample(exemplar.caption, exemplar.raw);
      })])([text5("show the legal passing move")])]))]);
    }
    ;
    throw new Error("Failed pattern match at Webapp.App (line 203, column 17 - line 219, column 8): " + [v.constructor.name]);
  };
  ...
  var statsStrip = function(i2) {
    var stat = function(label5) {
      return function(val) {
        return span3([class_("stat")])([span3([class_("stat-label")])([text5(label5)]), span3([class_("stat-value")])([text5(val)])]);
      };
    };
    var v = index(audits)(i2);
    if (v instanceof Nothing) {
    ...
    ;
    if (v instanceof Just) {
      return div2([class_("stats")])([stat("states")(show5(v.value0.total)), stat("malformed")(dashZero(v.value0.malformed)), stat("unsafe")(dashZero(v.value0.illegal)), stat("safe")(show5(v.value0.legal)), stat("coverage")(show5(v.value0.coverage) + " / 202 legal"), span3([class_("space-note")])([text5(v.value0.spaceNote)])]);
    }
    ;
    throw new Error("Failed pattern match at Webapp.App (line 162, column 16 - line 172, column 8): " + [v.constructor.name]);
  };
  var codePane = /* @__PURE__ */ section([/* @__PURE__ */ class_("code-pane")])([/* @__PURE__ */ div2([/* @__PURE__ */ id2("code-pane")])([])]);
  var render6 = function(st) {
    if (st.mode instanceof Full) {
      return div2([class_("app")])([header2, rungNav(st.rung), codePane, div2([class_("panes")])([junctionPane(st), galleryPane(st.rung)]), footer2]);
    }
    ;
    if (st.mode instanceof V0Only) {
      return div2([class_("v0-widget")])([statsStrip(st.rung), div2([class_("panes")])([junctionPane(st), galleryPane(st.rung)]), gridPane(st.rung)]);
    }
    ;
    throw new Error("Failed pattern match at Webapp.App (line 105, column 13 - line 125, column 8): " + [st.mode.constructor.name]);
  };
  var component = function(dictMonadEffect) {
    return mkComponent({
      initialState: function(mode) {
        return {
          mode,
          rung: (function() {
            if (mode instanceof Full) {
              return 0;
            }
            ;
            if (mode instanceof V0Only) {
              return 0;
            }
            ;
            throw new Error("Failed pattern match at Webapp.App (line 57, column 15 - line 59, column 22): " + [mode.constructor.name]);
          })(),
          selected: exemplar
        };
      },
  ...
  // output/Webapp.Eval/index.js
  var show6 = /* @__PURE__ */ show(showNumber);
  var show1 = /* @__PURE__ */ show(showInt);
  var eq13 = /* @__PURE__ */ eq(eqViolationClass);
  ...
  var shortLabel = function(v) {
    ...
    ;
    if (v instanceof ClassIntoOccupied) {
      return "green into occupied";
    }
    ;
    throw new Error("Failed pattern match at Webapp.Eval (line 37, column 14 - line 43, column 45): " + [v.constructor.name]);
  };
  var displayOrder = /* @__PURE__ */ (function() {
    return [ClassDerailment.value, ClassConflict.value, ClassCollision.value, ClassIntoOccupied.value];
  })();
  var row = function(a2) {
    var pct = function(n) {
      return show6(toNumber(n) / 16) + "%";
    };
    var segmentRaw = function(color) {
      return function(n) {
        return function(lbl) {
          return span3([class_("vbar-seg"), style("background:" + (color + (";width:" + pct(n)))), title2(lbl + (": " + (show1(n) + " states")))])([]);
        };
      };
    };
    var segment = function(s) {
      return segmentRaw(colorFor(new Just(s.cls)))(s.count)(shortLabel(s.cls));
    };
    var malformedNote = (function() {
      var $14 = a2.malformed === 0;
      if ($14) {
        return [];
      }
      ;
      return [show1(a2.malformed) + " malformed (off scale, not drawn)"];
    })();
    var countOf = function(c) {
      var v = filter(function(p2) {
        return eq13(p2.cls)(c);
      })(a2.primary);
      if (v.length === 1) {
        return v[0].count;
      }
    ...
    var unsafeSegments = filter(function(s) {
      return s.count > 0;
    })(map32(function(c) {
      return {
        cls: c,
    ...
    var note = joinWith("  \xB7  ")(append14([show1(a2.total) + " states"])(append14(malformedNote)(append14(map32(function(s) {
      return shortLabel(s.cls) + (" " + show1(s.count));
    })(unsafeSegments))(["safe " + show1(a2.legal)]))));
    return div2([class_("vbar-row")])([div2([class_("vbar-label")])([span3([class_("rname")])([text5(a2.name)]), span3([class_("rtech")])([text5(a2.technique)])]), div2([class_("vbar-track")])(append14(map32(segment)(unsafeSegments))([segmentRaw(colorFor(Nothing.value))(a2.legal)("safe")])), div2([class_("vbar-coverage")])([text5(show1(a2.coverage) + "/202")]), p([class_("vbar-note")])([text5(note)])]);
  };
  var render7 = /* @__PURE__ */ (function() {
    var legendSwatch = function(color) {
      return function(lbl) {
        return span3([class_("legend-item")])([span3([class_("swatch"), style("background:" + color)])([]), text5(lbl)]);
      };
    };
    var legendItem = function(c) {
      return legendSwatch(colorFor(new Just(c)))(shortLabel(c));
    };
    return div2([class_("vbars")])(append14(map32(row)(audits))([div2([class_("legend vbars-legend")])(append14(map32(legendItem)(displayOrder))([legendSwatch(colorFor(Nothing.value))("safe")]))]));
  })();
  ...
  var figures = /* @__PURE__ */ (function() {
    return [{
      ...
      selector: "#fig-conflict",
      raw: {
        greens: [EtoM.value, MtoA.value],
        p1: ToMain.value,
        p2: ToMain.value,
        occupancy: []
      }
    }, {
      selector: "#fig-derailment",
      raw: {
        greens: [AtoL.value],
        p1: ToMain.value,
        p2: ToLoop.value,
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ discard5(awaitLoad)(function() {
    return bind8(selectElement("#v0-widget"))(function(v0) {
      return discard5(for_1(v0)(function(el) {
        return $$void10(runUI2(component3)(V0Only.value)(el));
      }))(function() {
        return bind8(selectElement("#eval-root"))(function(evalRoot) {
          return discard5(for_1(evalRoot)(function(el) {
            return $$void10(runUI2(component2)(unit)(el));
          }))(function() {
            return discard5(for_22(figures)(function(fig) {
              return bind8(selectElement(fig.selector))(function(present) {
                if (present instanceof Nothing) {
                  return pure11(unit);
                }
                ;
                if (present instanceof Just) {
                  return liftEffect7(void1(rerender(fig.selector)(tree(fig.raw)(check(fig.raw)))));
                }
                ;
                throw new Error("Failed pattern match at Webapp.SiteMain (line 39, column 5 - line 42, column 48): " + [present.constructor.name]);
              });
            }))(function() {
              return for_22(mapWithIndex2(function(i2) {
                return function(rs) {
                  return {
                    i: i2,
                    rs
              ...
              })(reachSets))(function(entry) {
                var sel = "#grid-v" + show7(entry.i);
                return bind8(selectElement(sel))(function(present) {
                  if (present instanceof Nothing) {
                    return pure11(unit);
                  }
                  ;
                  if (present instanceof Just) {
                    return liftEffect7(void1(rerender(sel)(tree2(entry.rs))));
                  }
                  ;
                  throw new Error("Failed pattern match at Webapp.SiteMain (line 47, column 5 - line 50, column 34): " + [present.constructor.name]);
                });
              });
            });
          });
