...
(() => {
            ...
            return function(array) {
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  case 2:
                    return apply7(map32(array2)(f(array[bot])))(f(array[bot + 1]));
                  case 3:
                    return apply7(apply7(map32(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top2 - bot) / 4) * 2;
                    return apply7(map32(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
  ...
  var countDistinct = function(keys4) {
    ...
    var changes = length3(filter(identity9)(zipWith(function(x) {
      return function(y) {
        return x !== y;
      };
  ...
  var trains = function(raw) {
    var place = function(i2) {
      return function(o) {
        var clash = length3(filter(function(p2) {
    ...
    var positioned = mapWithIndex3(place)(raw.occupancy);
  ...
  var cells2 = /* @__PURE__ */ (function() {
    ...
    return mapWithIndex3(place)(sorted);
  })();
  ...
  var rungNav = function(active) {
    ...
    return nav([class_("rungs")])(mapWithIndex3(function(i2) {
      return function(a2) {
  ...
  var redrawJunction = function(dictMonadEffect) {
    ...
    return function(sel) {
      return liftEffect7($$void9(rerender("#junction")(tree(sel.raw)(check(sel.raw)))));
    };
  };
  var redrawGrid = function(dictMonadEffect) {
    var liftEffect7 = liftEffect(monadEffectHalogenM(dictMonadEffect));
    return function(i2) {
      return liftEffect7($$void9(rerender("#state-grid")(tree2(fromMaybe(empty7)(index2(reachSets)(i2))))));
    };
  };
  ...
  var injectCode = function(dictMonadEffect) {
    var liftEffect7 = liftEffect(monadEffectHalogenM(dictMonadEffect));
    return function(i2) {
      return liftEffect7(setHtml("#code-pane")(snippetFor(i2)));
    };
  };
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind7(get2)(function(st) {
          return discard5(redrawJunction1(st.selected))(function() {
        ...
        if (cc.exampleRaw instanceof Just) {
          return new Just(button([class_("example"), onClick(function(v2) {
            return new SelectExample(classLabel(cc.cls) + (", first counterexample at " + fromMaybe("")(map112(function(v1) {
              return v1.name;
            })(index2(audits)(i2)))), cc.exampleRaw.value0);
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return $$void10(runUI2(component2)(Full.value)(body2));
  }));
